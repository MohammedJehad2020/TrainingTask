    ...
    <div class="header-container container-xxl" id="headerContainer">
        ...
        <div class="d-flex align-items-center flex-wrap">
            ...
            <div class="d-flex align-items-center py-3 py-lg-0">
                ...
                <div class="me-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ auth()->user()->image ? asset('storage/uploads/users-images/'.auth()->user()->image) : asset('/assets/media/avatars/blank.png')}}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                       ...
                       {{--  <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-link px-5">{{ t('Log out') }}</a>
                ...
                <!--begin::Item-->
                <a href="#" class="btn btn-primary" data-bs-toggle="modal">New Goal</a>
                <!--end::Item-->
            </div>
            <!--end::Action-->
        </div>
