...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Nour Hashem @yield('title')</title>
		<meta charset="utf-8" />
                                ...
                                <h1 class="d-flex flex-column text-dark fw-bolder my-1">
                                	...
                                	<ul class="breadcrumb breadcrumb-line fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-gray-600">
                                            <a href="{{route('dashboard.index')}}" class="text-gray-600">Dashboard</a>
                                        </li>
                                        <li class="breadcrumb-item text-gray-400">@yield('title')</li>
								</ul>
...
$('#'+id_show_image+"_href").attr('href', e.target.result);
};
